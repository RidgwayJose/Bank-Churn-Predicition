...
class Data(BaseModel):
    ...
    NumOfProducts:   int = 2
    HasCrCard:       float = 1.0
    IsActiveMember:  float = 0.0
    EstimatedSalary: float = 181449.97
    #Exited: int = 0   #
...
def create_dataframe(data: Data):
    ...
    #exclude_variables = ['id','CustomerId','Surname','Exited']
    #df = data.drop(columns=exclude_variables)
